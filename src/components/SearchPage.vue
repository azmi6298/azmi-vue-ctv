...
<div class="container mx-auto">
  <div class="p-8 flex flex-col items-center justify-center space-y-10">
    <div class="bg-white flex w-6/12 items-center rounded-full shadow-xl">
      <input v-model="url" class="rounded-l-full w-full py-4 px-6 text-gray-700 leading-tight focus:outline-none" type="text" placeholder="Insert Youtube Link ...">
    </div>
    <div class="bg-white flex w-6/12 items-center rounded-full shadow-xl">
      <input v-model="keyword" class="rounded-l-full w-full py-4 px-6 text-gray-700 leading-tight focus:outline-none" type="text" placeholder="Insert Specific Keyword ...">
    </div>
    <!-- <div class="p-4">
    ...
    <div v-if="result == null" class="text-white px-6 py-4 border-0 rounded relative mb-4 bg-red-500">
  ...
  <section class="text-gray-700 body-font" v-if="result != null && result.total > 0">
...
export default {
  ...
  methods: {
    ...
    // TODO: fix show alert method
    // TODO: show search result on scrollable list
    // TODO: add footer
  }
}
</script>